...
## Other unrelated past work {data-visibility="uncounted"}
...
<iframe src="https://pat-laub.github.io/DeepLearningForActuaries/" width="100%" height="600" style="border:none;"></iframe>
...
- $\mathcal{L} = \{ (\overleftarrow{\mathbf{x}}_1, y_1) , \dots , (\overleftarrow{\mathbf{x}}_{n} , y_{n}) \}$
is _library set_,
- $\mathcal{P} = \{ (\overleftarrow{\mathbf{x}}_{n+1}, y_{n+1}) , \dots , (\overleftarrow{\mathbf{x}}_{T}, y_{T}) \}$
is _prediction set_.

<br>

For point $\overleftarrow{\mathbf{x}}_{s} \in \mathcal{P}$, pretend we don't know $y_s$ and try to predict it.

$$ \forall \, \overleftarrow{\mathbf{x}} \in \mathcal{L} \quad \text{ find } \quad d(\overleftarrow{\mathbf{x}}_{s}, \overleftarrow{\mathbf{x}}) $$
...
$$ w_i = \exp\bigl\{ - \theta d(\overleftarrow{\mathbf{x}}_{s}, \overleftarrow{\mathbf{x}}_i) \bigr\} $$
...
😎 "We actually also have a PhD scholarship if we have a domestic applicant who can commit like in next week" (need $\ge$ 85 in a 4 year degree)
...
# Appendix {data-background-image="unsw-yellow-shape.png" data-visibility="uncounted"}
...
## Noise / unobserved variables? {data-visibility="uncounted"}
